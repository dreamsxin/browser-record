...
const { buildOperationRouter } = require('./routes/operations');
...
function createApp(config) {
  ...
  const viewerDir = path.join(path.dirname(require.resolve('../../playwright-custom/playwright-core')), 'lib', 'vite', 'traceViewer');
  ...
  app.use('/api/operations', buildOperationRouter(config));
